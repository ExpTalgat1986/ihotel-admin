<template>
  <q-page>
    <h4 class="section-title q-mb-lg">Управление категориями блюд</h4>
    ...
    <div v-else class="text-center text-subtitle1">Отсутствуют категории блюд</div>
  ...
  setup() {
    ...
    const deleteItem = async () => {
      try {
        ...
        await Api.deleteFoodCategory(pickedSectionId.value)
